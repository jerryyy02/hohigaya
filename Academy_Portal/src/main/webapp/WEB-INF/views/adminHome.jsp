...
height:120px;
font-weight: bold;
 -webkit-box-shadow: 10px 10px 30px 14px rgba(188,190,194,0.39);
  -moz-box-shadow: 10px 10px 30px 14px rgba(188,190,194,0.39);
  box-shadow: 10px 10px 49px 14px rgba(188,190,194,0.39);
}
...
<ul class="nav navbar-nav all">
    ...
    <li><a href="admin/registerUser.html" class="btn btn-danger navbar-btn nevButton1"><br>
    <span class="glyphicon glyphicon-user" width="50px"></span><br><br>
	Register New User</a></li>
	
    <li><a href="admin/addModule.html" class="btn btn-danger navbar-btn nevButton1"><br>
    <span class="glyphicon glyphicon-save-file"></span><br><br>
	Add Module</a></li>
	
    <li><a href="admin/batchAllocation.html" class="btn btn-danger navbar-btn nevButton1"><br>
    <span class="glyphicon glyphicon-book"></span><br><br>
	Batch Allocation</a></li>
	
    <li><a href="admin/updateBatch.html" class="btn btn-danger navbar-btn nevButton1"><br>
    <span class="glyphicon glyphicon-calendar"></span><br><br>
	Update Batch</a></li>
	
    <li><a href="admin/insertBatch.html" class="btn btn-danger navbar-btn nevButton1"><br>
    <span class="glyphicon glyphicon-edit"></span><br><br>
	Insert Batch</a></li>
	
    <li><a href="admin/generateReport.html" class="btn btn-danger navbar-btn nevButton1"><br>
    <span class="glyphicon glyphicon-list-alt"></span><br><br>
	Generate Report</a></li>
	
    <li><a href="admin/insertSkill.html" class="btn btn-danger navbar-btn nevButton1"><br>
    <span class="glyphicon glyphicon-education"></span><br><br>
	Insert Skill</a></li>
</ul>
