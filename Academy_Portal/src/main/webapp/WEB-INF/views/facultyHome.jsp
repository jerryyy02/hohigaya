...
<title>Faculty ${user.fName} ${user.lName} </title>
...
<ul class="nav navbar-nav all">
    ...
    <li><a href="faculty/addFaculty.html" class="btn btn-danger navbar-btn nevButton1"><br>
    <span class="glyphicon glyphicon-user" width="50px"></span><br><br>
	To Update Faculty Details</a></li>
	
    <li><a href="faculty/reportManagement.html" class="btn btn-danger navbar-btn nevButton1"><br>
    <span class="glyphicon glyphicon-save-file"></span><br><br>
	To Enter Report Details</a></li>
	
    <li><a href="faculty/insertFacultySkill.html" class="btn btn-danger navbar-btn nevButton1"><br>
