...
<ul class="nav navbar-nav all">
    <li></li>
    <li><a href="addFaculty.html" class="btn btn-danger navbar-btn nevButton1">To Update Faculty Details</a></li>
    <li><a href="reportManagement.html" class="btn btn-danger navbar-btn nevButton">To Enter Report Details</a></li>
    <li><a href="insertFacultySkill.html" class="btn btn-danger navbar-btn nevButton">Insert Skill</a></li>
           ...
           <h2>Update Faculty</h2> 
             <form id="login-form" action="addFaculty.html" method="post" role="form" style="display: block;">
                  ...
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="fisrtName" id="fisrtName" tabindex="1" class="form-control" placeholder="Enter First Name" value="" required>
                  </div>
                   <div class="form-group">
                    <input type="text" autocomplete="off" name="lastName" id="lastName" tabindex="1" class="form-control" placeholder="Enter Last Name" value="" required>
                  </div>
                  <div class="form-group">
                    <input type="number" autocomplete="off" name="age" id="age" tabindex="1" class="form-control number" placeholder="Enter Age" value="" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="number" autocomplete="off" name="contactNo" pattern="" id="contactNo" tabindex="1" class="form-control number" placeholder="Enter Contact No" min="7000000000" and max="9999999999"  value="" required>
                  </div>
				<div class="form-group">
                    <input type="email" autocomplete="off" name="emailId" id="emailId" tabindex="1" class="form-control" placeholder="Enter Email Id" value="" required>
                  </div>
