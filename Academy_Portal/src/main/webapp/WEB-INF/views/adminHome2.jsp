...
<ul class="nav navbar-nav all">
    <li></li>
    <li><a href="addFaculty.html" class="btn btn-danger navbar-btn nevButton">To Update Faculty Details</a></li>
    <li><a href="reportManagement.html" class="btn btn-danger navbar-btn nevButton1">To Enter Report Details</a></li>
        ...
        <div class="panel-body">
          <div class="row">
            ...
            <h2>Report Management<a href="logout.html" class="form-control btn logout">Logout </a> </h2>
             <form id="login-form" action="reportManagement.html" name="reportManagement" method="post" role="form" style="display: block;">
                  ...
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="weeklyReport" id="weeklyReport" tabindex="2" class="form-control" placeholder="Weekly Report" value="" required>
                  </div>
                   <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="text" autocomplete="off" name="mockTest" id="mockTest" tabindex="3" class="form-control" placeholder="Mock Test" value="" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6 col-sm-offset-3">
                        <input type="submit" name="register-submit" id="report_submit" tabindex="4" class="form-control btn btn-register" value="Submit">
                      </div>
                    </div>
                  </div>
              </form>
...
<script>
 ...
 var x = document.forms["reportManagement"]["batchId"].value;
 var y = document.forms["reportManagement"]["facultyId"].value;
 
  if (x == "batch") {
    alert("Please Select Batch and Faculty");
    return false;
  }
  if (y=="faculty") {
	    alert("Please Select Batch and Faculty");
